...
reduce_std <- function(data, measure, group_vars, n_boot = 20, seed = 123) {
...
write.csv(reduced_eff_summary, "reduced_eff_summary.csv", row.names = FALSE)

```
```{r }

reduced_eff_summary <- read.csv("reduced_eff_summary.csv")
