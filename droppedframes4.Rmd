...
plot_df<-filter(df, Test==tests & Frame<=525 & Repeat==reps & Filt_Type==filt |Filt_Type=='Dropped' )

summary(plot_df)

#pdf("figures/4dropped3.pdf")

plt<-ggplot(plot_df, aes(x = Frame, y = Frame_Val, color = Test)) +
