...
occraw<- read_csv("occlusion_v6.csv",show_col_types = FALSE)
err_raw<- read_csv("occ_est_error3.csv",show_col_types = FALSE)
...
plotibble<-filter(droppedocc, NumofDropped !='4_Drops', MAV_Type !='OccHybrid', MAV_Type !='Comb',EffortType=="Force")
...
long_tibble<-long_tibble%>%mutate(Error_Names=recode(Corrected_Errors,
                                ...
                                'Effort_MAV_err' = 'After_Correction',
