...
occ<-occ%>%filter(Test!="mar7",Test!="mar16",Test!="feb27",Test!="may19",Test!="apr20")
...
lm_tibble <- lm_tibble %>%
 ...
 m1 <- lm(Occ_mvc ~ MVC_Voli + MVC_Stim + Test, data = lm_tibble) 
...
ggplot(plotibble, aes(x =  VoliMVC , y = Dropped_MAV*100, color = StimMVC))+
  geom_point() +
